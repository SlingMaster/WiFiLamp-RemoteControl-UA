...
1. Исправлена ошибка с инициализацией будильника,
	* если даже существкет корректный alarm_config.json всеравно нужно зайти в настройки лампы и и нажать кнопку Сщхранить настройки, чтобы данные будильника прописались в Eeprom
------------------------------------------------------------------------------------------	
