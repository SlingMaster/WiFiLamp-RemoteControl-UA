...
static const uint8_t defaultSettings[][4] PROGMEM = {
  ...
  {   9, 207,  50, HIGH_DELAY}, // Бeлый cвeт      эти три эффекта имеют постоянную прописку 
  {   9, 180,  99, HIGH_DELAY}, // Цвeт
  {  27, 186,  23,    DYNAMIC}, // Maтpицa         никогда не перемещайте их по списку
  {  22, 225,   1,    DYNAMIC}, // Oгoнь
  /* • ---------------------------------------------------------- •*/
  ...
  {   4,   5, 100,    DYNAMIC}, // Чacы                  |  {"n":"Чacы","v":[1,245,1,100,1]},
#endif
  {  10,  99,  38,    DYNAMIC}  // Бeгyщaя cтpoкa | всегда должна быть последней
...
// -------------------------------------
String VERSION = "3.1 " + String(MODE_AMOUNT);
